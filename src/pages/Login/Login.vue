          ...
          <form @submit.prevent="login">
            <div :class="{on:loginWay}">
              <section class="login_message">
                <input type="text" maxlength="11" placeholder="手机号" v-model="phone"  :disabled="computeTime>0? true:false" >
            ...
            <div :class="{on:!loginWay}">
              <section>
                ...
                <section class="login_message">
                  ...
                  <img class="get_verification" src="http://www.liu.com/captcha/default?zYC5yAYL" alt="captcha" @click="getCaptcha" ref="captcha">
                </section>
              </section>
            </div>
...
export default {
    data(){
      return {
        loginWay:false,//true代表密码登录 false 代表短信登录
        phone:'',
        computeTime:0,//倒计时时间
    ...
    methods:{
      ...
      getCaptcha(){
        this.$refs.captcha.src = 'http://www.liu.com/captcha/default?zYC5yAYL&time=' + Date.now()
      },
